  ...
  <main class="meus-anuncios">
    ...
    if (!empty($_SESSION)) {
      ...
      curl_setopt_array($curl, [
        CURLOPT_URL => 'http://localhost/E_space/E_space/routes/index.php/anuncios/usuario',
...
<?php }
    ...
    $curl = curl_init();
    curl_setopt_array($curl, [
      CURLOPT_URL => 'http://localhost/E_space/E_space/routes/index.php/anuncios/delete',
