  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="">
        ...
        <button class="btn btn-outline-success" type="button"  data-bs-toggle='modal' data-bs-target="#loginModal" >FAZER LOGIN</button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="text-center" >
            <span>Deseja criar uma conta ? <a href="./cadastro.php">  Criar Conta</a></span>
          </div>
        </div>
      </div>
    </div>
