...
<body>
      ...
      <ul class="menu">
        ...
        if (!empty($_SESSION)) {
          ...
          curl_setopt_array($curl, [
            CURLOPT_URL => 'http://localhost/E_space/E_space/routes/index.php/imagem',
  ...
  <main class="main-home">
    ...
    curl_setopt_array($curl, [
      CURLOPT_URL => 'http://localhost/E_space/E_space/routes/index.php/anuncios/destaque',
      CURLOPT_CUSTOMREQUEST => "GET",
      CURLOPT_RETURNTRANSFER => true,
    ]);
    ...
    <div class="anuncios wrapper">
      <div class="anuncios-recentes">
        ...
        if (empty($_POST['pesquisar'])) {
          ...
          $curl = curl_init();
          curl_setopt_array($curl, [
            CURLOPT_URL => 'http://localhost/E_space/E_space/routes/index.php/anuncios',
            CURLOPT_CUSTOMREQUEST => "GET",
            CURLOPT_RETURNTRANSFER => true,
          ]);
          ...
          $curl = curl_init();
          curl_setopt_array($curl, [
            CURLOPT_URL => 'http://localhost/E_space/E_space/routes/index.php/anuncios/pesquisa',
            CURLOPT_CUSTOMREQUEST => "GET",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_POSTFIELDS => $json,
            CURLOPT_HTTPHEADER => [
